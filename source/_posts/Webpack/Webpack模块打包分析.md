...
1995年，最初的JavaScript诞生.

用于在客户端进行一些DOM的修改，为用户减少一些流量请求。

那时的HTML页面任何一个文字的修改都需要从后台获取全部的文件。

当然，最为重要的是，以那时的带宽来说，每一丝流量都弥足珍贵。



作为一门初生的脚本语言，地位卑微，甚至连他的命名都是为了蹭上Java的热度。

直到浏览器大热，成为大家网上冲浪的第一选择，JavaScript的地位也随之水涨船高。

日益提升的网站体量，一个简单的JS文件显然无法承载大量复杂的需求。



无数开发者揭竿而起，提出自己新思想，开源自己的封装库，

从 原生JS  到  脚本库 到 模板语法 到 框架， 

前端从一个脚本语言的刀耕火种，到现在的 组件化 模块化 工程化。



前端开发者花了20年时间，__从 脚本仔 变成了 工程师__

在前端工程化中，`Rollup`/`Gulp`/`Webpack`等一众打包工具功不可没

本系列将探索 对目前最流行的前端打包方案  __Webpack5 __ 进行探索 
...
本篇精心选取了Webpack最简单的 __模块化打包__ 原理,带大家迈开了解Webpack的第一脚
...
如果你非常喜欢我的Webpack系列,请点赞支持,

后续可能推出Webpack 按需加载, 热更新, AST, Tree-Shaking 等原理的讲解.

如果你对框架技术更为关注,请在评论区留言,Vue 和 React 源码也可以拉出来和大家唠一唠.



感谢大家，我是紫宇，一个间歇性努力的懒前端.